...
class L2M2019Env(OsimEnv):
    ...
    def __init__(self, visualize=True, integrator_accuracy=5e-5, difficulty=0, seed=None, report=None, desired_speed=None, model_path: str = None):
        self.desired_speed = desired_speed
        if difficulty not in [0, 1, 2, 3]:
            raise ValueError("difficulty level should be in [0, 1, 2, 3].")
        self.model_paths = {}
        self.model_paths['2D'] = model_path
        self.model_paths['3D'] = model_path
